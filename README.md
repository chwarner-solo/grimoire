...
Design decisions are documented as ADRs in [`grimoire-domain/docs/adr/`](grimoire-domain/docs/adr/).

| ADR | Title |
|-----|-------|
| [ADR-001](grimoire-domain/docs/adr/ADR-001_Game-Holds-Campaign-Ids.md) | Game Holds CampaignIDs Not SessionIDs |
| [ADR-002](grimoire-domain/docs/adr/ADR-002_State-pattern-for-aggregates.md) | State Pattern for Aggregate Lifecycles |
| [ADR-003](grimoire-domain/docs/adr/ADR-003_CQRS-split-read-write.md) | CQRS Split — Aggregates Write, Neo4j Reads |
| [ADR-004](grimoire-domain/docs/adr/ADR-004_Six-cononical-events.md) | Six Canonical Event Types |
| [ADR-005](grimoire-domain/docs/adr/ADR-005_NDJSON-over-parquet.md) | ndjson Over Parquet for Event Storage |
| [ADR-006](grimoire-domain/docs/adr/ADR-006_Typed-UUIDS-for-identity.md) | Typed UUIDs for All Identity |
| [ADR-007](grimoire-domain/docs/adr/ADR-007_GrimoireID-base-struct.md) | GrimoireID Base Struct via Embedding |
| [ADR-008](grimoire-domain/docs/adr/ADR-008_GraphQL-API-LAyer.md) | GraphQL API Layer |
| [ADR-009](grimoire-domain/docs/adr/ADR-009_Bidirectional-Event-Mapping.md) | Bidirectional Event Mapping |
| [ADR-010](grimoire-domain/docs/adr/ADR-010_Three-Stores-Architecture.md) | Three Stores Architecture |
| [ADR-011](grimoire-domain/docs/adr/ADR-011_Domain-Event-Chaining.md) | Domain Event Chaining |
